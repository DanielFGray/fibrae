...
Effect.gen(function* () {
  ...
  // Wrapper components using ErrorBoundary JSX API
  const SafeCrashDuringRender = () => (
    <ErrorBoundary fallback={() => <div data-cy="fallback-render">Render Error</div>}>
      <CrashDuringRender />
    </ErrorBoundary>
  );

  const SafeEventFailer = () => (
